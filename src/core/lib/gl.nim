...
proc load_GL_ARB_multisample(load: proc) =
  ...
  glSampleCoverageARB = cast[proc (value: GLfloat,
      invert: GLboolean) {.stdcall.}](load("glSampleCoverageARB"))


proc load_GL_EXT_framebuffer_multisample(load: proc) =
  if not GLAD_GL_EXT_framebuffer_multisample: return
  glRenderbufferStorageMultisampleEXT = cast[proc (target: GLenum,
      samples: GLsizei, internalformat: GLenum, width: GLsizei,
      height: GLsizei) {.stdcall.}](load("glRenderbufferStorageMultisampleEXT"))
