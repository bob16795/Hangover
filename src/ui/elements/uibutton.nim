...
proc newUIButton*(texture: Texture, bounds: UIRectangle,
  ...
  if texture.isDefined():
    ...
    result.buttonNormal = newUiSprite(texture, newRect(0, 0, 1, 1),
          newRect(0.25, 0.25, 0.25, 0.25)).scale(64)
    result.buttonFocused = newUiSprite(texture, newRect(33, 0, 32, 32),
          newRect(40, 8, 8, 8))
